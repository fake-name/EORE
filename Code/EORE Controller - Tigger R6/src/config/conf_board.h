...
// Pin definitions
#define LED_1           IOPORT_CREATE_PIN(PIOA, 27)
#define LED_2           IOPORT_CREATE_PIN(PIOA, 11)
#define LED_3           IOPORT_CREATE_PIN(PIOA, 26)
...
#define NOISE_DIODE_PS  IOPORT_CREATE_PIN(PIOB,  2)
#define VCO_SWEEPER_PS  IOPORT_CREATE_PIN(PIOA,  0)

#define CS_1            IOPORT_CREATE_PIN(PIOB,  3)
#define CS_2            IOPORT_CREATE_PIN(PIOA, 17)
#define CS_3            IOPORT_CREATE_PIN(PIOA, 18)
#define CS_4            IOPORT_CREATE_PIN(PIOA, 19)
#define CS_5            IOPORT_CREATE_PIN(PIOA, 16)
#define CS_6            IOPORT_CREATE_PIN(PIOA, 15)
...
// Temperature sensors get their own TWI module.
#define TEMP_SENSOR_SCL      IOPORT_CREATE_PIN(PIOB, 1)
#define TEMP_SENSOR_SDA      IOPORT_CREATE_PIN(PIOB, 0)
#define TEMP_SENSOR_TWI      TWI2
